...
export default function Navbar() {
  ...
  return <>
    ...
    <a href="/#formularz" onClick={(e) => handleScroll(e, '/#formularz')} className="sm:hidden fixed bottom-[env(safe-area-inset-bottom,1.5rem)] left-4 right-4 z-50 bg-[#00ff00] text-black px-4 py-4 text-center text-base font-black uppercase shadow-[0_4px_14px_rgba(0,255,0,0.25)] border border-neon/50">BEZPŁATNA DIAGNOZA</a>
  </>;
}
