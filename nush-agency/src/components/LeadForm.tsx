export default function LeadForm() {
  return (
    <section id="audyt" className="py-24 px-6 md:px-10 bg-[#000] relative border-b border-white/10">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          <div className="flex-1">
            <h2 className="font-mono text-xs font-bold uppercase tracking-widest text-neon mb-4">[04] SZYBKA ANALIZA</h2>
